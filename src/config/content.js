...
export const PROGRAMMES = [
    { title: 'Program Management Dashboard', description: 'Full-stack governance-compliant PM tool: timesheet approvals, expense tracking, audit trails and multi-tenant support. Reduced manual reporting by 36%.', url: null, techStack: ['Node.js / Express', 'Drizzle ORM', 'Tailwind CSS', 'Replit'], imageSource: `${LIVE}/api/files/projects/1778689863091_73d52e31-941f-405e-bab3-f9ed4669c60e_Screenshot_2026-05-11_at_13.00.31.png` },
    { title: 'Risk Radar — AI Program Risk Monitor', description: 'AI-driven programme risk monitoring tool built for Careem, surfacing delivery risks in real time.', url: 'https://carreemriskradar.replit.app', techStack: ['Node.js', 'OpenAI API', 'REST API'], imageSource: `${LIVE}/api/files/projects/1781870408313_3661f6f9-a8eb-46dd-953a-3a6b3462b49b_Screenshot_2026-06-19_at_15.59.40.png` },
    { title: 'Executive Dashboard for Program Management', description: 'Executive-level programme dashboard with AI-generated MD pack summaries, responsive across desktop and mobile.', url: 'https://Moove-Executive-Dashboard.replit.app', techStack: ['Node.js / Express', 'Chart.js', 'JavaScript'], imageSource: `${LIVE}/api/files/projects/1781871599229_260895e2-19af-40cf-b0cb-29ec66a80fe7_Screenshot_2026-06-19_at_16.05.36.png` },
    { title: 'Energy Consumption Benchmark Tool', description: 'GSMA benchmarking tool helping telecom operators monitor and reduce their energy consumption, aligned to the UN 2030 SDGs.', url: 'https://www.gsma.com/solutions-and-impact/technologies/networks/digest/gsma-beta-labs-launches-energy-benchmarking-tool-to-help-operators-monitor-their-energy-consumptions/', techStack: [], imageSource: `${LIVE}/api/files/projects/1778690322739_963ba91a-a91a-46c2-a31c-41f361b928a1_Screenshot_2026-05-11_at_12.24.49.png` },
    { title: 'This Portfolio — Full-Stack CV Platform', description: 'Full-stack portfolio with admin CMS, blog engine, CV download gate and AI chatbot. Built end-to-end on Replit.', url: `${LIVE}/`, techStack: ['React', 'TypeScript', 'Drizzle ORM', 'PostgreSQL'], imageSource: `${LIVE}/api/files/projects/1778689838976_a3e6414b-b470-4c38-91d3-d149afd585ab_Screenshot_2026-05-11_at_14.51.56.png` },
    { title: 'Digital Transformation — e-commerce', description: 'Delivered an e-commerce digital transformation for Novocycle, standing up an online storefront and fulfilment flow.', url: 'https://shop.novocycle.com/', techStack: [], imageSource: `${LIVE}/api/files/projects/1778690399929_1ac07160-e9b9-4f40-a9fd-19effdf5170e_Screenshot_2026-05-11_at_12.16.49.png` },
];
