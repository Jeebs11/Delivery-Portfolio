...
// Available cloud textures (?v=3 cache-bust: redesigned hand-drawn clouds)
const CLOUD_TEXTURES = [
    '/textures/clouds/1131c3eb-dfae-423f-924b-ff39d8ccd6dc.webp?v=3',
    '/textures/clouds/254b8ec8-d6f7-4275-956f-7bab65b2ce2d.webp?v=3',
    '/textures/clouds/2cc88dd1-483c-466d-b07e-f8308c61ccbe.webp?v=3',
    '/textures/clouds/5606fcc0-3252-447d-a58a-7bcbac73229a.webp?v=3',
    '/textures/clouds/7882dc72-3d01-41fb-ac0e-d07b0184ebc1.webp?v=3',
    '/textures/clouds/9b2ca72f-7bd0-473b-ba6e-dd9e0eb79d35.webp?v=3',
    '/textures/clouds/c83293c6-d90c-4a32-8d9d-5ac9af7e2296.webp?v=3',
    '/textures/clouds/f6e358bc-d27c-41dd-95f4-6787a835c41e.webp?v=3',
];
...
const StaticCloud = ({ position, scale, opacity, textureIndex, driftSpeed, initialOffset, rotationOffset }) => {
    ...
    // Aspect ratios of the redesigned clouds (prevents stretching).
    const legacyCloudAspects = {
        '1131c3eb-dfae-423f-924b-ff39d8ccd6dc.webp': 1.087,
        '254b8ec8-d6f7-4275-956f-7bab65b2ce2d.webp': 2.147,
        '2cc88dd1-483c-466d-b07e-f8308c61ccbe.webp': 3.977,
        '5606fcc0-3252-447d-a58a-7bcbac73229a.webp': 3.684,
        '7882dc72-3d01-41fb-ac0e-d07b0184ebc1.webp': 1.983,
        '9b2ca72f-7bd0-473b-ba6e-dd9e0eb79d35.webp': 2.251,
        'c83293c6-d90c-4a32-8d9d-5ac9af7e2296.webp': 2.006,
        'f6e358bc-d27c-41dd-95f4-6787a835c41e.webp': 3.704
    };
